# Generated by Django 5.1.2 on 2025-06-19 09:02
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Personnel_pays', models.CharField(choices=[('côte_ivoire', 'côte_ivoire'), ('Ghana', 'Ghana'), ('Nigeria', 'Nigeria'), ('Bénin', 'Bénin'), ('Gabon', 'Gabon'), ('liberia', 'liberia')], default='côte_ivoire', max_length=20)),
                ('Date_ajout', models.DateTimeField(default=django.utils.timezone.now, editable=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('deleted_by_cascade', models.BooleanField(default=False, editable=False)),
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False, verbose_name='ID')),
                ('statut', models.CharField(choices=[('en_attente', 'En Attente'), ('selection_en_cours', 'Sélection en cours'), ('ACCONAGE_FAIT', 'Empotage en cours'), ('Aconage_en_cours', "En Attente d'empotage"), ('dossier_termine', 'Terminé')], default='en_attente', max_length=25)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dossier', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='declarations', to='conteneurs.dossier')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_modification', models.DateTimeField(auto_now=True)),
                ('statut', models.CharField(choices=[('Terminé', 'Terminé'), ('En Attente', 'En Attente')], default='En Attente', max_length=10)),
                ('dossier', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='copies_bls', to='conteneurs.dossier')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('numero_plomb4', models.CharField(blank=True, max_length=50, null=True)),
                ('photo_plomb4', models.ImageField(blank=True, null=True, upload_to='photos_plomb4/')),
                ('numero_plomb5', models.CharField(blank=True, max_length=50, null=True)),
                ('photo_plomb5', models.ImageField(blank=True, null=True, upload_to='photos_plomb5/')),
                ('temperature', models.FloatField(blank=True, null=True, verbose_name='Température (°C)')),
                ('photo_selection1', models.ImageField(blank=True, null=True, upload_to='photo_selection1/')),
                ('photo_selection2', models.ImageField(blank=True, null=True, upload_to='photo_selection2/')),
                ('photo_selection3', models.ImageField(blank=True, null=True, upload_to='photo_selection3/')),
                ('Date_ajout', models.DateTimeField(default=django.utils.timezone.now, editable=False)),
                ('statut', models.CharField(choices=[('Non_aconer', 'Non habillé & Non empoté'), ('aconer', 'Empoté')], default='Non_aconer', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_modification', models.DateTimeField(auto_now=True)),
                ('statut', models.CharField(choices=[('Terminé', 'Terminé'), ('En Attente', 'En Attente')], default='En Attente', max_length=10)),
                ('dossier', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='confirmations_booking', to='conteneurs.dossier')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_modification', models.DateTimeField(auto_now=True)),
                ('statut', models.CharField(choices=[('Terminé', 'Terminé'), ('En Attente', 'En Attente')], default='En Attente', max_length=10)),
                ('dossier', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='coas', to='conteneurs.dossier')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_modification', models.DateTimeField(auto_now=True)),
                ('statut', models.CharField(choices=[('Terminé', 'Terminé'), ('En Attente', 'En Attente')], default='En Attente', max_length=10)),
                ('dossier', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='certificats_phytosanitaires', to='conteneurs.dossier')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_modification', models.DateTimeField(auto_now=True)),
                ('statut', models.CharField(choices=[('Terminé', 'Terminé'), ('En Attente', 'En Attente')], default='En Attente', max_length=10)),
                ('dossier', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='certificats_origine', to='conteneurs.dossier')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_modification', models.DateTimeField(auto_now=True)),
                ('statut', models.CharField(choices=[('Terminé', 'Terminé'), ('En Attente', 'En Attente')], default='En Attente', max_length=10)),
                ('dossier', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='autorisations_exportation', to='conteneurs.dossier')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_modification', models.DateTimeField(auto_now=True)),
                ('statut', models.CharField(choices=[('Terminé', 'Terminé'), ('En Attente', 'En Attente')], default='En Attente', max_length=10)),
                ('dossier', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ecs', to='conteneurs.dossier')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_modification', models.DateTimeField(auto_now=True)),
                ('statut', models.CharField(choices=[('Terminé', 'Terminé'), ('En Attente', 'En Attente')], default='En Attente', max_length=10)),
                ('dossier', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='factures_commerciales', to='conteneurs.dossier')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_modification', models.DateTimeField(auto_now=True)),
                ('statut', models.CharField(choices=[('Terminé', 'Terminé'), ('En Attente', 'En Attente')], default='En Attente', max_length=10)),
                ('dossier', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='packing_lists', to='conteneurs.dossier')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_modification', models.DateTimeField(auto_now=True)),
                ('statut', models.CharField(choices=[('Terminé', 'Terminé'), ('En Attente', 'En Attente')], default='En Attente', max_length=10)),
                ('dossier', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='rapports_empotage', to='conteneurs.dossier')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_modification', models.DateTimeField(auto_now=True)),
                ('statut', models.CharField(choices=[('Terminé', 'Terminé'), ('En Attente', 'En Attente')], default='En Attente', max_length=10)),
                ('dossier', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='rapports_selection', to='conteneurs.dossier')),
            ],
            options={
                'abstract': False,
            },
