...
from conteneurs.forms import DossiersForm, DossiersNigeriaForm
...
class DossierCreateNigeriaView(CreateView):
    ...
    def form_valid(self, form):
        ...
        pays_nigeria = Pays.objects.get(nom="Nigeria")  # Remplacer par le pays souhaité
        form.instance.pays = pays_nigeria
