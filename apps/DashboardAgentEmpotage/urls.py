...
from .views.dossier_empotage.create import renseigner_empotage, renseigner_empotage_ajax
...
urlpatterns = [
    ...
    path('conteneurs/<uuid:pk>/empoter/ajax/', renseigner_empotage_ajax, name='conteneur-empoter-ajax'),
